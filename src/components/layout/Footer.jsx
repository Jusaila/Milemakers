      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          ...
          <div className="md:col-span-1 flex flex-col gap-2">
            ...
            <div className="w-[118px] h-[123px] rounded-full overflow-hidden flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                <img
                src="/icons/logo.png"
            ...
            <p className="text-[rgba(0,0,0,0.5)] text-[20px] leading-relaxed max-w-[380px]">
          ...
          <div className="flex flex-col gap-3 mt-[100px]">
            <h4 className="text-[#1a1a1a] text-xs font-bold tracking-widest uppercase mb-1">
              Quick Links
            </h4>
            {quickLinks.map((link) => (
              <a
                key={link}
                href="#"
                className="text-[rgba(0,0,0,0.5)]  text-xs hover:text-[#2d4a2d] transition-colors"
              >
                {link}
              </a>
            ))}
          ...
          {/* Col 3 — Contact Info */}
          <div className="flex flex-col gap-3 mt-[100px]">
            <h4 className="text-[#] text-xs font-bold tracking-widest uppercase mb-1">
              Contact Info
            </h4>
            <p className="text-[rgba(0,0,0,0.5)]  text-xs">+91 8281-797072</p>
            <p className="text-[rgba(0,0,0,0.5)]  text-xs">Milemakers.in@gmail.com</p>
          </div>
  
          {/* Col 4 — Newsletter + Social */}
          <div className="flex flex-col gap-4 mt-[100px]">
            {/* Email subscribe */}
            <div className="flex items-center gap-0 border border-[#d0cdc8] rounded-full overflow-hidden bg-white">
              <input
                type="email"
